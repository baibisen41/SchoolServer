...
<head>
    <meta charset="utf-8">
    <title>控制台</title>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/Css/identify.css"/>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/Css/layout.css"/>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/Css/account.css"/>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/Css/style.css"/>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/Css/control_index.css"/>
    <script type="text/javascript" src="<%=basePath%>/Js/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="<%=basePath%>/Js/layer/layer.js"></script>
    <script type="text/javascript" src="<%=basePath%>/Js/haidao.offcial.general.js"></script>
    <script type="text/javascript" src="<%=basePath%>/Js/select.js"></script>
    <script type="text/javascript" src="<%=basePath%>/Js/haidao.validate.js"></script>
</head>
    ...
    <div class="topbar-console">
        <div class="tobar-head fl">
            <a href="#" class="topbar-logo fl">
                <span><img src="<%=basePath%>/Images/logo.png" width="20" height="20"/></span>
            </a>
            <a href="index.html" class="topbar-home-link topbar-btn text-center fl"><span>白碧森的管理控制台</span></a>
        </div>
    </div>
        ...
        <div class="sidebar-content">
            <div class="sidebar-nav">
                ...
                <ul class="sidebar-trans">
                    <li>
                        <a href="webSet.html">
                            <b class="sidebar-icon"><img src="<%=basePath%>/Images/icon_author.png" width="16" height="16"/></b>
                            <span class="text-normal">站点管理</span>
                        </a>
                    </li>
                    <li>
                        <a href="smsInfo.html">
                            <b class="sidebar-icon"><img src="<%=basePath%>/Images/icon_message.png" width="16" height="16"/></b>
                ...
                <ul class="sidebar-trans">
                    <li>
                        <a href="userInfo.html">
                            <b class="sidebar-icon"><img src="<%=basePath%>/Images/icon_cost.png" width="16" height="16"/></b>
                            <span class="text-normal">账号管理</span>
                        </a>
                    </li>
                    <li>
                        <a href="identify.html">
                            <b class="sidebar-icon"><img src="<%=basePath%>/Images/icon_authentication.png" width="16"
                                                         height="16"/></b>
                    ...
                    <li>
                        <a href="message.html">
                            <b class="sidebar-icon"><img src="<%=basePath%>/Images/icon_news.png" width="16" height="16"/></b>
                            <span class="text-normal">消息中心</span>
                        </a>
                    </li>
                    <li>
                        <a href="money.html">
                            <b class="sidebar-icon"><img src="<%=basePath%>/Images/icon_gold.png" width="16" height="16"/></b>
                            <span class="text-normal">金币管理</span>
                        </a>
                    </li>
                    <li>
                        <a href="order.html">
                            <b class="sidebar-icon"><img src="<%=basePath%>/Images/icon_order.png" width="16" height="16"/></b>
    ...
    <div class="view-product">
        <div class="info-center">
            <div class=" padding-big-tb manage-head">
                <h6 class="padding-left manage-head-con">金币管理<span class="own text-normal">拥有金币：<em
                        class="text-roseo h2 margin-right">150</em>枚</span></h6>
            </div>
